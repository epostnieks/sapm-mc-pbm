#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Pharmacy Benefit Management / Spread Extraction Trap
====================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Pharmacy Benefit Management (Spread Extraction Trap).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "pbm",
    "domain_name": "Pharmacy Benefit Management",
    "theorem": "Spread Extraction Trap",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 60.0,
    "channels": {
        "C1_spread_extraction": {
            ...
            "high": 249.5,
            "weight": 0.35,
            "description": "PBM spread pricing $30-50B/yr in opaque spreads. Sources: FTC 2024, PCMA."
        },
        "C2_patient_cost_shifting": {
            ...
            "high": 113.4,
            "weight": 0.2,
            "description": "Copay clawbacks, formulary steering. Sources: NCPA, CMS."
        },
        "C3_pharmacy_consolidation": {
            ...
            "high": 90.7,
            "weight": 0.18,
            "description": "Independent pharmacy closures, pharmacy deserts. Sources: NCPA census, FTC."
        },
        "C4_rebate_distortion": {
            ...
            "high": 62.4,
            "weight": 0.15,
            "description": "Rebate bias against generics/biosimilars. Sources: IQVIA, Biosimilars Forum."
        },
        "C5_regulatory_opacity": {
            ...
            "high": 31.2,
            "weight": 0.12,
            "description": "ERISA preemption, no fiduciary duty. Sources: FTC, state AG investigations."
        }
    },
    "impossibility_floor": 3.5
}
